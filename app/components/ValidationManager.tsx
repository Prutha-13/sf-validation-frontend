...
const BACKEND = 'https://sf-validation-backend-8py3.onrender.com';
...
export default function ValidationManager() {
  ...
  const fetchRules = async () => {
    ...
    try {
      ...
      setMessage('❌ Failed to fetch rules. Backend may be sleeping, try again in 10s.');
    }
    setLoading(false);
  };
    ...
    <main className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-gray-500 mb-8">
          Manage Account validation rules directly from this app
        </p>
        ...
        {!token ? (
          ...
          <div>
            ...
            {message && (
              <p className="text-blue-600 mb-4 font-medium">{message}</p>
            )}
            {loading && (
              <p className="text-gray-400 mb-4">Loading rules...</p>
            )}
